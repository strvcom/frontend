...
Besides whenever you are working on a project for a long time, you are getting a \[tunnel vision\]\([https://en.wikipedia.org/wiki/Tunnel\_vision\_\(metaphor\)](https://en.wikipedia.org/wiki/Tunnel_vision_%28metaphor%29)\), which results in not seeing obvious bugs.
